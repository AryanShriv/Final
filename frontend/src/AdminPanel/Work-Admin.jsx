            ...
            <div>
              <div className="mb-6">
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Banner Video Url: </label>

                  <input
                    placeholder="Banner Video Url"
                    className="bg-gray-300 w-1/2 text-gray-700 border border-gray-400 rounded-md py-2 px-4 mb-4 focus:outline-none focus:ring-1 focus:ring-blue-500 transition ease-in-out duration-150"
                    type="text"
                    value={bannerUrl}
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Image Url: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Video Url: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >About - Text: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >About - Video URL: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 1: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 2: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 3: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 4: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 5: </label>
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 6: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 7: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 8: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 9: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 10: </label>
                  <input
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 11: </label>
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 12: </label>
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 13: </label>
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 14: </label>
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 15: </label>
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 16: </label>
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 17: </label>
                ...
                <div className="flex justify-between items-center mr-5">
                  <label  style={{ textTransform: 'uppercase'}} >Work - URL 18: </label>
                  <input
